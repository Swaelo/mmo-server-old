...
namespace Swaelo_Server
{
    ...
    public static class DisplaySphere
    {
        ...
        public static void GetShapeMeshData(EntityCollidable collidable, List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(0, radius, 0), Microsoft.Xna.Framework.Vector3.Up, Microsoft.Xna.Framework.Vector2.Zero));
            for (int i = 1; i < NumSides / 2; i++)
            {
                ...
                for (int j = 0; j < NumSides; j++)
                {
                    ...
                    vertices.Add(new VertexPositionNormalTexture(n * radius, n, Microsoft.Xna.Framework.Vector2.Zero));
                }
            }
            vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(0, -radius, 0), Microsoft.Xna.Framework.Vector3.Down, Microsoft.Xna.Framework.Vector2.Zero));
