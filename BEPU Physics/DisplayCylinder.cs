    ...
    public static class DisplayCylinder
    {
        ...
        public static void GetShapeMeshData(EntityCollidable collidable, List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            for (int i = 0; i < NumSides; i++)
            {
                ...
                //Top cap
                vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(x, verticalOffset, z), Microsoft.Xna.Framework.Vector3.Up, Microsoft.Xna.Framework.Vector2.Zero));
                //Top part of body
                vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(x, verticalOffset, z), new Microsoft.Xna.Framework.Vector3(x, 0, z), Microsoft.Xna.Framework.Vector2.Zero));
                //Bottom part of body
                vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(x, -verticalOffset, z), new Microsoft.Xna.Framework.Vector3(x, 0, z), Microsoft.Xna.Framework.Vector2.Zero));
                //Bottom cap
                vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(x, -verticalOffset, z), Microsoft.Xna.Framework.Vector3.Down, Microsoft.Xna.Framework.Vector2.Zero));
            }
