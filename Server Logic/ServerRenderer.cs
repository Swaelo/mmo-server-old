// ================================================================================================================================
// File:        ServerRenderer.cs
// Description: This class handles the MonoGame rendering window, used to give an extremely helpful view of everything going on
// Author:      Harley Laurie          
// Notes:       We need to figure out how to add the option of having the server run without rendering anything at all, this will
//              be extremely useful to remove all the overhead the render window creates, for running the server long term
// ================================================================================================================================
