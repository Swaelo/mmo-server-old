...
namespace Swaelo_Server
{
    ...
    public static class DisplayCapsule
    {
        ...
        public static void GetShapeMeshData(EntityCollidable collidable, List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            var n = new Microsoft.Xna.Framework.Vector3();
            var offset = new Microsoft.Xna.Framework.Vector3(0, capsuleShape.Length / 2, 0);
            float angleBetweenFacets = MathHelper.TwoPi / NumSides;
            float radius = capsuleShape.Radius;

            //Create the vertex list
            //Top
            vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(0, radius + capsuleShape.Length / 2, 0), Microsoft.Xna.Framework.Vector3.Up, Microsoft.Xna.Framework.Vector2.Zero));
            //Upper hemisphere
            for (int i = 1; i <= NumSides / 4; i++)
            {
                ...
                for (int j = 0; j < NumSides; j++)
                {
                    ...
                    vertices.Add(new VertexPositionNormalTexture(n * radius + offset, n, Microsoft.Xna.Framework.Vector2.Zero));
                }
            }
            //Lower hemisphere
            ...
            //Bottom
            vertices.Add(new VertexPositionNormalTexture(new Microsoft.Xna.Framework.Vector3(0, -radius - capsuleShape.Length / 2, 0), Microsoft.Xna.Framework.Vector3.Down, Microsoft.Xna.Framework.Vector2.Zero));
