...
namespace Swaelo_Server
{
    ...
    public class InstancedModelDrawer : ModelDrawer
    {
            ...
            : base(game)
        {
            ...
            instancingEffect.Parameters["LightDirection1"].SetValue(Microsoft.Xna.Framework.Vector3.Normalize(new Microsoft.Xna.Framework.Vector3(.8f, -1.5f, -1.2f)));
            instancingEffect.Parameters["DiffuseColor1"].SetValue(new Microsoft.Xna.Framework.Vector3(.66f, .66f, .66f));
            instancingEffect.Parameters["LightDirection2"].SetValue(Microsoft.Xna.Framework.Vector3.Normalize(new Microsoft.Xna.Framework.Vector3(-.8f, 1.5f, 1.2f)));
            instancingEffect.Parameters["DiffuseColor2"].SetValue(new Microsoft.Xna.Framework.Vector3(.3f, .3f, .5f));
