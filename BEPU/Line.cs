...
namespace Swaelo_Server
{
    ...
    public class Line
    {
        ...
        public Line(Color colorA, Color colorB, LineDrawer drawer)
        {
            ...
            drawer.GetNewLineIndex(out IndexA);
            IndexB = IndexA + 1;
            drawer.vertices[IndexA].Position = Microsoft.Xna.Framework.Vector3.Zero;
            drawer.vertices[IndexA].Color = colorA;
            drawer.vertices[IndexB].Position = Microsoft.Xna.Framework.Vector3.Zero;
            drawer.vertices[IndexB].Color = colorB;
        }
        ...
        /// </summary>
        public Microsoft.Xna.Framework.Vector3 PositionA
        {
        ...
        /// </summary>
        public Microsoft.Xna.Framework.Vector3 PositionB
        {
