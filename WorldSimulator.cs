...
namespace Swaelo_Server
{
    public class WorldSimulator
    {
        ...
        public WorldSimulator(WorldRenderer game)
        {
            ...
            //Add a new boxes at random locations
            StaticEntity TestEntity = new StaticEntity(new Vector3(5, 5, 5));
            StaticEntity TestEntity2 = new StaticEntity(new Vector3(15, 15, 15));
            ...
            int[] TerrainIndices;
            Model TerrainCollision = Globals.game.Content.Load<Model>("tera");
            ...
            ////Create an instance of the FSM Entity class to test out its functionality
            //EntityTest = new FSMEntity(new Vector3(-17.74f, 2.15f, 10.54f), new Vector3(-40.63f, 1.55f, 25.64f));
            //EntityManager.AddEntity(EntityTest);
        ...
        public void Update(float dt)
        {
            ...
            //Count down until clients need to be updated
            //NextEntityUpdate -= dt;
            //if (NextEntityUpdate <= 0.0f)
            //{
            //    NextEntityUpdate = EntityUpdateInterval;
            //    List<Client> ClientList = ClientManager.GetAllActiveClients();
            //    List<BaseEntity> EntityList = EntityManager.ActiveEntities;
            //    PacketSender.SendListEntityUpdates(ClientList, EntityList);
            //}
