...
namespace Server.Data
{
    class GlobalsDatabase
    {
        ...
        public static int GetNextItemID()
        {
            ...
            MySqlCommand ItemIDCommand = new MySqlCommand(ItemIDQuery, Database.Connection);
        ...
        public static void SaveNextItemID(int NextItemID)
        {
            ...
            MySqlCommand NewItemIDCommand = new MySqlCommand(NewItemIDQuery, Database.Connection);
