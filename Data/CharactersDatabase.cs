...
namespace Server.Data
{
    class CharactersDatabase
    {
        ...
        public static bool IsCharacterNameAvailable(string CharacterName)
        {
            ...
            MySqlCommand CharactersCommand = new MySqlCommand(CharactersQuery, Database.Connection);
        ...
        public static int GetCharacterCount(string AccountName)
        {
            ...
            MySqlCommand CharacterCountCommand = new MySqlCommand(CharacterCountQuery, Database.Connection);
        ...
        public static void SaveNewCharacter(CharacterData NewCharacterData)
        {
            ...
            MySqlCommand NewCharacterCommand = new MySqlCommand(NewCharacterQuery, Database.Connection);
            ...
            MySqlCommand NewCharacterCountCommand = new MySqlCommand(NewCharacterCountQuery, Database.Connection);
        ...
        public static string GetCharacterName(string AccountName, int CharacterSlot)
        {
            ...
            MySqlCommand CharacterNameCommand = new MySqlCommand(CharacterNameQuery, Database.Connection);
        ...
        public static CharacterData GetCharacterData(string CharacterName)
        {
            ...
            MySqlCommand CharacterDataCommand = new MySqlCommand(CharacterDataQuery, Database.Connection);
        ...
        public static void SaveCharacterLocation(string CharacterName, Vector3 CharacterLocation)
        {
            ...
            MySqlCommand CharacterLocationCommand = new MySqlCommand(CharacterLocationQuery, Database.Connection);
