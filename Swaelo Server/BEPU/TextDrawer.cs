...
namespace Swaelo_Server
{
    ...
    public class TextDrawer
    {
        ...
        public void Draw(string text, Microsoft.Xna.Framework.Vector2 position)
        {
        ...
        /// <param name="position">Position to draw the text at.</param>
        public void Draw(string text, int value, Microsoft.Xna.Framework.Vector2 position)
        {
            SpriteBatch.DrawString(Font, text, position, Color);
            Draw(value, new Microsoft.Xna.Framework.Vector2(position.X + Font.MeasureString(text).X, position.Y));
        }
        ...
        /// <param name="position">Position to draw the text at.</param>
        public void Draw(string text, double value, Microsoft.Xna.Framework.Vector2 position)
        {
            SpriteBatch.DrawString(Font, text, position, Color);
            Draw(value, new Microsoft.Xna.Framework.Vector2(position.X + Font.MeasureString(text).X, position.Y));
        }
        ...
        /// <param name="position">Position to draw the text at.</param>
        public void Draw(string text, double value, int numPlaces, Microsoft.Xna.Framework.Vector2 position)
        {
            SpriteBatch.DrawString(Font, text, position, Color);
        ...
        public Microsoft.Xna.Framework.Vector2 Draw(int value, Microsoft.Xna.Framework.Vector2 position)
        {
            Microsoft.Xna.Framework.Vector2 nextPosition = position;
        ...
        /// <param name="position">The screen position specifying where to draw the value.</param>  
        /// <returns>The next position on the line to draw text. This value uses position.Y and position.X plus the equivalent of calling spriteFont.MeasureString on value.ToString(CultureInfo.InvariantCulture).</returns>  
        public Microsoft.Xna.Framework.Vector2 Draw(double value, Microsoft.Xna.Framework.Vector2 position)
        {
        ...
        /// <param name="position">The screen position specifying where to draw the value.</param>  
        /// <returns>The next position on the line to draw text. This value uses position.Y and position.X plus the equivalent of calling spriteFont.MeasureString on value.ToString(CultureInfo.InvariantCulture).</returns>  
        public Microsoft.Xna.Framework.Vector2 Draw(double value, int numPlaces, Microsoft.Xna.Framework.Vector2 position)
        {
            Microsoft.Xna.Framework.Vector2 nextPosition = position;
