...
namespace Swaelo_Server
{
    static class PacketSender
    {
        ...
        {
            Console.WriteLine("send player message");
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("send players message");
        ...
        {
            Console.WriteLine("send login reply");
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("send create character reply");
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("send character data");
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("sending player ingame");
        ...
        {
            Console.WriteLine("send spawn other player");
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("send list spawn other");
            foreach (Client Client in ClientList)
        ...
        {
            Console.WriteLine("send player update position");
            //Create the packet to send through the network
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("send remove other player");
            ByteBuffer.ByteBuffer PacketWriter = new ByteBuffer.ByteBuffer();
        ...
        {
            Console.WriteLine("send list remove other player");
